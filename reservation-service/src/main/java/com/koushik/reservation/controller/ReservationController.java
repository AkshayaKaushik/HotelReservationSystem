...
public class ReservationController implements IReservationController {
	...
	@Override
	public ApiResponse<ReservationGuestDetails[]> getReservationByGuest(String name) {
		ApiResponse<ReservationGuestDetails[]> response = new ApiResponse<>();
		response.setData(reservationService.getReservationForGuest(name));
